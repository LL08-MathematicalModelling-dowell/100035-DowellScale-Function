...
#                 return Response({"success": True, "scale_id":scale_id, "no_of_scales":no_of_scales, "event_id": settings_event_id, "instances_used": len(instance_ids), "instance_ids": instance_ids }, status=status.HTTP_200_OK)
#             else:
