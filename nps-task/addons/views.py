...
class ScaleCreateAPIView(APIView):
    ...
    def generate_urls(self, payload, id):
        ...
        #     instances = [
        #         f"{public_url}/addons/create-response/?user={user_type}&scale_type={scale_type}&workspace_id={workspace_id}&username={username}&scale_id={id}&item={i}"]
        ...
        for i in range(len(channel_list)) :
            for j in scale_range :
                ...
                # instances = [f"{public_url}/addons/create-response/?user={user_type}&scale_type={scale_type}&channel={channel}&workspace_id={workspace_id}&username={username}&scale_id={id}&item={j}"]
        ...
        try:
            ...
            if current_instance_id <= no_of_instances:
                ...
                if user_type == "True":
                    ...
                    generated_url = f"{product_url}/?username={username}&workspace_id={workspace_id}&scale_type={scale_type}&score={item}&channel={channel_name}&instance={channel_instance_id}"
