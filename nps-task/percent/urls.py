...
from .views import (dowell_scale_admin,dowell_scale1, default_scale, default_scale_admin,
                    ...
                    scale_response_api_view, scale_settings_api_view, single_scale_response_api_view,
                    single_scale_settings_api_view
)
...
urlpatterns = [
    ...
    path('api/percent_settings', scale_settings_api_view, name="percent_scale_settings_api"),
    path('api/percent_responses', scale_response_api_view, name="percent_scale_response_api"),
    path('api/percent_settings/<str:id>', single_scale_settings_api_view, name="percent_single_scale_settings_api"),
