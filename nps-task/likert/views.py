    ...
    if request.method == "POST":
        try:
            ...
            if scale_settings['data'][0]['settings'].get('label_type') == "emoji":
                upper_boundary = scale_settings['data'][0]['settings'].get(
                    'label_selection')
            ...
            existing_response = dowellconnection("dowellscale", "bangalore", "dowellscale", "scale_reports",
                                                 "scale_reports", "1095", "ABCDE", "fetch", {"event_id": event_id}, "nil")
            ...
            response_id = dowellconnection("dowellscale", "bangalore", "dowellscale",
                                           "scale_reports", "scale_reports", "1094", "ABCDE", "insert", response, "nil")
