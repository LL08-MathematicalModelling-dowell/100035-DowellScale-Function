...
#         self.assertEqual(scale_data["topic"], payload["topic"])
...
#         self.assertEqual(response.data["error"],  "statement_count missing or mispelt")
...
#         url = reverse(self.response_url)
#         payload = {
#                     "scale_id": "653b6c9d38ec7dcbdb556c1a",
#                     "username": "natan",
#                     "instance_id": 1,
#                     "brand_name": "Brand XYZ",
#                     "statements": [    
