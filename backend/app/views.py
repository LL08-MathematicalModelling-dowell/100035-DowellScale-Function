...
class UserManagement(APIView):
    def post(self,request, format=None):
        ...
        if serializer.is_valid():
            ...
            password = serializer.validated_data["portfolio_id"]
    ...
    def get(self,request):
        ...
        password = request.GET.get("portfolio_id")
        if workspace_id and portfolio_id and password:
            ...
            return Response({"Error":"Provide workspace_id, porfolio_id and password"},status=status.HTTP_400_BAD_REQUEST)
