...
from .api_v5 import CreatedNPSLiteScale, CreatedNPSLiteResponse
app_name = 'nps-lite'
urlpatterns = [
    ...
    path('api/v5/nps-lite-create-scale/', CreatedNPSLiteScale.as_view(), name='nps-lite-created-scale'),
    path('api/v5/nps-lite-create-response/', CreatedNPSLiteResponse.as_view(), name='nps-lite-created-response'),
]
