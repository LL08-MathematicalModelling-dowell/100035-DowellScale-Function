    ...
    <nav className="flex items-center justify-between w-full p-4 bg-[#1A8753] md:justify-center">
      ...
      <div>
        <Link
          to={
            import.meta.env.DEV
              ? 'https://100014.pythonanywhere.com/en/sign-out/?redirect_url=localhost:3000'
              : 'https://100014.pythonanywhere.com/en/sign-out/?redirect_url=https://ll08-mathematicalmodelling-dowell.github.io/100035-DowellScale-Function/'
          }
        >
