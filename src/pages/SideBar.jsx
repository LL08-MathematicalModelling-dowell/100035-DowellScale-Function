...
const SideBar = () => {
  ...
  return (
    <div className='lg:w-3/12  overflow-y-auto h-screen' style={{backgroundColor:'#54595F', width: reduceSize ? '50px' :'250px', marginRight: '50px', position: 'fixed', display: screenWidth < 640 ? 'none': ''}}>
