...
let textList=["FROM 9 -> 10","FROM 6 -> 8","FROM 5 -> 4","FROM 2 -> 3","FROM 0 -> 1"]
...
export default function NPSScale() {
 ...
 <Recommendation 
        ...
        titleText={"Considering your experience with <product>, how likely would you be to recommend <product> to your friend or colleague"}
        titleStyle={{ alignSelf: 'center', backgroundColor: 'orange', padding: 10, marginTop: 10, fontColor: 'red', fontSize: 10, fontWeight: 'bold', color: 'red' }}
